...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col">
            ...
            ?>
            <form action="/dataMaster/saveFasilitas" method="post" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <section>
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('nama_fasilitas')) ? 'is-invalid' : ''; ?>" id="nama_fasilitas" name="nama_fasilitas" autofocus value="<?= old('nama_fasilitas'); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" class="form-control <?= ($validation->hasError('icon')) ? 'is-invalid' : ''; ?>" id="icon" name="icon" autofocus value="<?= old('icon'); ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
